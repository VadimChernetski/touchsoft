$(document).ready(function(){
    $("#pagination").click(function(event){
        ...
        $.ajax({
            ...
            type: "GET",
            url: "/agent/agents/show?page=" + pages + "&size=" + sizeOfPage + "&status=" + status,
            dataType: 'json',
            cache: false,
            timeout:60000,
    ...
    $("#freeagents").click(function(event){
            event.preventDefault();
            $.ajax({
                        headers: {
                        'Accept': 'application/json',
                        ...
                        type: "GET",
                        url: "/agent/agents/free",
                        dataType: 'json',
                        cache: false,
                        timeout:60000,
                        success: function(responseJsonObject){
                        var free = "Free agents " + responseJsonObject;
                            $("#free").append(free);
                        },
                        error:function(e){
                        console.log(e);
